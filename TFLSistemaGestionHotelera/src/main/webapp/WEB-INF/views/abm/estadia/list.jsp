...
<body>
	<div class="generic-container">
		...
		<div class="panel-heading"><span class="lead">Estadia</span></div>
...
<% /* ******************************************************************************** *
	  ...
	  ******************************************************************************** */ %>
	  					...
	  					<sec:authorize access="hasAnyRole('ADMIN', 'USER','DBA')">
							<td><a href="<c:url value='/pasajeroEstadia/list?idEstadia=${entity.id}' />" class="btn btn-success">Habitaciones/Pasajeros</a></td>
						</sec:authorize>
